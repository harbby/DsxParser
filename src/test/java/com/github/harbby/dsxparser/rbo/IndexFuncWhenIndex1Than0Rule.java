...
public class IndexFuncWhenIndex1Than0Rule
        implements RboRule<ComparisonExpression>
{
    @Override
    ...
    @Override
    public Expression optimize(ComparisonExpression expression)
    {
        Expression left = expression.getLeft();
        var operator = expression.getOperator();
        Expression right = expression.getRight();
        ...
        Expression column = arguments.get(0);
